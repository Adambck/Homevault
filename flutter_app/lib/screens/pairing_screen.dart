...
class _PairingScreenState extends State<PairingScreen> {
  ...
  Future<void> _scanQr() async {
    ...
    // Expected QR payload: "homevault://<host>?token=<token>"
    final uri = Uri.tryParse(result);
    if (uri == null || uri.scheme != 'homevault') {
      setState(() => _error = 'Ongeldige QR-code');
      return;
    }
    final host = uri.host;
    final token = uri.queryParameters['token'];
    if (host.isEmpty || token == null) {
      setState(() => _error = 'QR-code mist gegevens');
      return;
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Verbind met je mini-PC',
                  textAlign: TextAlign.center,
              ...
              FilledButton(
                onPressed: _busy
                    ? null
                    : () => _connect(_hostCtrl.text.trim(), _tokenCtrl.text.trim()),
                child: Padding(
